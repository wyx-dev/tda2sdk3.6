...
#include "chains_hal_single_cam_vpe_resize_save.h"
#include "src/hlos/adas/src/usecases/hal_camera/camera_base.h"

#define CAPTURE_SENSOR_WIDTH     (1280)
#define CAPTURE_SENSOR_HEIGHT    (720)

Chains_hal_single_cam_vpe_resize_saveAppObj g_hal_single_cam_vpe_resize_save_AppObj;

static Void chains_hal_single_cam_vpe_resize_save_SetSyncPrm(chains_hal_single_cam_vpe_resize_saveObj *pUcObj)
{
...
Void chains_hal_single_cam_vpe_resize_save_set_output_frame_prms(CaptureLink_CreateParams *pPrm)
{
 ...
 *******************************************************************************
*/
static Void chains_hal_single_cam_vpe_resize_save_SetVpePrm(
 ...
 *******************************************************************************
*/
Void chains_hal_single_cam_vpe_resize_save_SetAppPrms(chains_hal_single_cam_vpe_resize_saveObj *pUcObj,Void *appObj)
{
    Chains_hal_single_cam_vpe_resize_saveAppObj *pObj
            = (Chains_hal_single_cam_vpe_resize_saveAppObj*)appObj;
    ...
    chains_hal_single_cam_vpe_resize_save_set_output_frame_prms(&pUcObj->CapturePrm);
    ...
    chains_hal_single_cam_vpe_resize_save_SetVpePrm(&pUcObj->VPE_resize_0Prm,
                                1,
    ...
    chains_hal_single_cam_vpe_resize_save_SetVpePrm(&pUcObj->VPE_resize_1Prm,
                                1,
    ...
    chains_hal_single_cam_vpe_resize_save_SetVpePrm(&pUcObj->VPE_resize_2Prm,
                                1,
    ...
    chains_hal_single_cam_vpe_resize_save_SetVpePrm(&pUcObj->VPE_resize_3Prm,
                                1,
    ...
    chains_hal_single_cam_vpe_resize_save_SetSyncPrm(pUcObj);
}
 ...
 *
 * \param   pObj  [IN] chains_hal_single_cam_vpe_resize_saveAppObj
 *
 *
 *******************************************************************************
*/
void chains_hal_single_cam_vpe_resize_save_StartApp(Chains_hal_single_cam_vpe_resize_saveAppObj *pObj)
{
    ...
    chains_hal_single_cam_vpe_resize_save_Start(&pObj->ucObj);
}
...
int chains_hal_single_cam_vpe_resize_save_StopApp(Chains_hal_single_cam_vpe_resize_saveAppObj *pObj)
{
    ...
    chains_hal_single_cam_vpe_resize_save_Stop(&pObj->ucObj);

    chains_hal_single_cam_vpe_resize_save_Delete(&pObj->ucObj);
 ...
 *******************************************************************************
*/
Void chains_hal_single_cam_vpe_resize_save(Chains_Ctrl *chainsCfg)
{
    char ch;
    UInt32 done = FALSE;
    Chains_hal_single_cam_vpe_resize_saveAppObj chainsObj;

    chainsObj.chainsCfg = chainsCfg;

    chains_hal_single_cam_vpe_resize_save_Create(&chainsObj.ucObj, &chainsObj);

    chains_hal_single_cam_vpe_resize_save_StartApp(&chainsObj);
    ...
    while(!done)
    {
        ...
        switch(ch)
        {
            ...
            case 'P':
                ...
                chains_hal_single_cam_vpe_resize_save_printStatistics(&chainsObj.ucObj);
                chains_hal_single_cam_vpe_resize_save_printBufferStatistics(&chainsObj.ucObj);
                break;
            default:
    ...
    chains_hal_single_cam_vpe_resize_save_StopApp(&chainsObj);
}

static int hal_single_cam_vpe_resize_save_get_timestamp(hal_frame_data_t *frmdata, UInt64 m4_timestamp)
{
	struct timeval time;
...
Void hal_single_cam_vpe_resize_save_null_link_callback(System_LinkChInfo *pChInfo, Void *pBuf, Void *arg)
{
	int ret =0;
	UInt64	m4Timestamp;
    ...
    /*timestamp change*/
	ret = hal_single_cam_vpe_resize_save_get_timestamp(&frmdata, m4Timestamp);
	if(ret < 0)
	{
		Vps_printf("--Error!!!-----hal_single_cam_vpe_resize_save_null_link_callback--------\n");
		return;
	}
